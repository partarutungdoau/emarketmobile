...
public class katBumbuPem extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kat_bumbu_pem);
        ...
        listview.setOnItemClickListener(katBumbuPem.this);
...
//        });
    ...
    public void setup() {
        ...
        Call<List<DataProduk>> call = service.getSemuaProdukBuah();
        call.enqueue(new Callback<List<DataProduk>>() {
            ...
            public void onResponse(Call<List<DataProduk>> call, Response<List<DataProduk>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter = new ListArrayAdapter(katBumbuPem.this, R.layout.row_produk, dataproduk);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(katBumbuPem.this, DetailProdukSayurPem.class);
