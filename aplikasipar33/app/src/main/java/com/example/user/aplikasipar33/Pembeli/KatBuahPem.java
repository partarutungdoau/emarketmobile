...
public class KatBuahPem extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kat_buah_pem);
        ...
        listview.setOnItemClickListener(KatBuahPem.this);
...
//        });
        ...
        call.enqueue(new Callback<List<DataProduk>>() {
            ...
            public void onResponse(Call<List<DataProduk>> call, Response<List<DataProduk>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter = new ListArrayAdapter(KatBuahPem.this, R.layout.row_produk, dataproduk);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(KatBuahPem.this, DetailProdukSayurPem.class);
