...
public class KatRempahPem extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kat_rempah_pem);
        ...
        listview.setOnItemClickListener(KatRempahPem.this);
...
//        });
    ...
    public void setup() {
        ...
        Call<List<DataProduk>> call = service.getSemuaProdukRempah();
        call.enqueue(new Callback<List<DataProduk>>() {
            ...
            public void onResponse(Call<List<DataProduk>> call, Response<List<DataProduk>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter = new ListArrayAdapter(KatRempahPem.this, R.layout.row_produk, dataproduk);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(KatRempahPem.this, DetailProdukSayurPem.class);
