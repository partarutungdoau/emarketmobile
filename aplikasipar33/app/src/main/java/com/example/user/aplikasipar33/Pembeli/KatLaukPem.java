...
public class KatLaukPem extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kat_lauk_pem);
        ...
        listview.setOnItemClickListener(KatLaukPem.this);
...
//        });
    ...
    public void setup() {
        ...
        Call<List<DataProduk>> call = service.getSemuaProdukLauk();
        call.enqueue(new Callback<List<DataProduk>>() {
            ...
            public void onResponse(Call<List<DataProduk>> call, Response<List<DataProduk>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter = new ListArrayAdapter(KatLaukPem.this, R.layout.row_produk, dataproduk);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(KatLaukPem.this, DetailProdukSayurPem.class);
