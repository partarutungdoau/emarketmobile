...
public class katSembakoPem extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kat_sembako_pem);
        ...
        listview.setOnItemClickListener(katSembakoPem.this);
...
//        });
    ...
    public void setup() {
        ...
        Call<List<DataProduk>> call = service.getSemuaProdukSembako();
        call.enqueue(new Callback<List<DataProduk>>() {
            ...
            public void onResponse(Call<List<DataProduk>> call, Response<List<DataProduk>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    adapter = new ListArrayAdapter(katSembakoPem.this, R.layout.row_produk, dataproduk);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(katSembakoPem.this, DetailProdukSayurPem.class);
